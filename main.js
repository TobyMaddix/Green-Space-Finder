...
$(document).ready(function()
{
    ...
    function mainSectionArticle_display(data, distance, id) //show search result
    {
    ...
    /* Start website */
    getStats("media/database/stats.json"); //Stats
    ...
    /* User inputs */
    $("#searchField").one("click", function() //Get location
    {
        $("#searchField").val("");
    ...
    $("#searchButton").click(function() //Search spaces (Btn)
    {
        getSpaces();
    });

    $('#searchField').keypress(function(event) //Search spaces (Enter)
    {
